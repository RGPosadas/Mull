...
export const mockAllEvents: Event[] = [
  {
    ...
    title: 'Liskar',
    description: 'Vroom Vroom',
    startDate: new Date('2027-10-27T01:31:00.000Z'),
    endDate: new Date('2027-11-01T01:31:00.000Z'),
    restriction: 0,
    host: userWithId1,
    coHosts: [userWithId7],
  ...
  },
  {
    ...
    startDate: new Date('2027-10-29T13:30:00.000Z'),
    endDate: new Date('2027-11-01T01:30:00.000Z'),
    restriction: 1,
    host: userWithId7,
    coHosts: [userWithId1],
    participants: [userWithId3],
  ...
  },
  {
    ...
    startDate: new Date('2027-10-29T20:20:00.000Z'),
    endDate: new Date('2027-10-31T22:09:00.000Z'),
    restriction: 0,
    host: userWithId7,
    coHosts: [userWithId1],
    participants: [userWithId3],
